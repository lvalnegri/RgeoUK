##################################################
# UK GEOGRAPHY * 31 - Lookups+Names FROZEN TYPES #
##################################################
...
y1 <- unique(fread( './data-raw/csv/ons/OA11_LSOA11_MSOA11-EW.csv', select = c('MSOA11CD', 'MSOA11NM'), col.names = c('MSOA', 'MSOAn') ))
