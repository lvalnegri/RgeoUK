...
x <- "
    ...
    LAD CHAR(9) NOT NULL COMMENT 'Local Authority District (UA-E06/W06, LAD-E07, MD-E08, LB-E09, CA-S12, DCA-N09) [Admin]',
    CTY CHAR(9) NOT NULL COMMENT 'County (C-E10, MC-E11, IOL-E13, plus LAD-E060=>E069; England Only; pseudo: WLS_CTY, SCO_CTY, NIE_CTY) [Admin]',
    RGN CHAR(9) NOT NULL COMMENT 'Region (E12; England Only; pseudo: WLS_RGN, SCO_RGN, NIE_RGN) [Admin]',
    CTRY CHAR(3) NOT NULL COMMENT 'Country (E92 = ENG, W92 = WLS, S92 = SCO, N92 = NIE) [Admin]',
...
x <- "
    ...
    CTY CHAR(9) NOT NULL COMMENT 'County (C-E10, MC-E11, IOL-E13, plus LAD-E060=>E069; England Only; pseudo: WLS_CTY, SCO_CTY, NIE_CTY)',
    RGN CHAR(9) NOT NULL COMMENT 'Region (E12; England Only; pseudo: WLS_RGN, SCO_RGN, NIE_RGN)',
    CTRY CHAR(3) NOT NULL COMMENT 'Country (E92 = ENG, W92 = WLS, S92 = SCO, N92 = NIE)',
    PRIMARY KEY (WPZ),
    INDEX MSOA (MSOA),
    INDEX LAD (LAD),
    INDEX CTY (CTY),
